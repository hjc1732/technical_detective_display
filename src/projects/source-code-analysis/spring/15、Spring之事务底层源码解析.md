...
1. 1. 代理对象执行b()方法前，判断出来了当前线程中已经存在一个数据库连接a了，表示当前线程其实已经拥有一个Spring事务了，则进行**挂起**
...
![img](https://cdn.nlark.com/yuque/0/2021/jpeg/365147/1633591520178-89c5ca58-a58a-4584-90b1-473a6c4ad80f.jpeg)



**其中，以非事务方式运行，表示以非Spring事务运行，表示在执行这个方法时，Spring事务管理器不会去建立数据库连接，执行sql时，由Mybatis或****JdbcTemplate自己来建立数据库连接来执行sql。**
